...
export function nextTrack(result) {
  return { type: PlaylistsTypes.NEXT_TRACK, payload: result };
}
export function previousTrack(result) {
  return { type: PlaylistsTypes.NEXT_TRACK, payload: result };
}
...
export function deletePlaylist(id) {
  return async function createThunk(dispatch) {
    try {
      dispatch(playlistAuth(api.deletePlaylist, id));
    } catch (error) {
...
export function removeTrackPlaylistAction(data) {
  return async function createThunk(dispatch) {
    try {
      dispatch(playlistAuth(api.removeTrackPlaylist, data));
    } catch (error) {
      console.log(error, "deleteTrackError");
    }
  };
